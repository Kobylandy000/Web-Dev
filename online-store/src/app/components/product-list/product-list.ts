  ...
  products: Product[] = [
    {
      ...
      description: 'Apple iPhone 17 Pro в цвете Cosmic Orange (оранжевый) с 256 ГБ встроенной памяти — флагман 2025 года с 6,3-дюймовым дисплеем Super Retina XDR (120 Гц). Смартфон работает на процессоре A19 Pro, имеет 12 ГБ ОЗУ, улучшенную тройную камеру 48 Мп с 8-кратным зумом и разъем USB-C.',
      price: 771806,
      rating: 4.9,
      images: [
    ...
    },
    {
      ...
      description: 'Apple iPhone 15 128GB (Black) — флагманский смартфон 2023 года с 6,1-дюймовым OLED-дисплеем Super Retina XDR, Dynamic Island, процессором A16 Bionic и разъемом USB-C. Основная камера 48 Мп.',
      price: 389868,
      rating: 4.9,
      images: [
    ...
    },
    {
      ...
      description: 'Apple iPhone 13 128GB (Black) — флагманский смартфон 2021 года с 6,1-дюймовым OLED-дисплеем Super Retina XDR, процессором A15 Bionic и разъемом Lightning. Основная камера 12 Мп.',
      price: 305000,
      rating: 4.9,
      images: [
    ...
    },
    {
      ...
      description: 'Apple iPhone 17 Pro Max в цвете Cosmic Orange (оранжевый) с 256 ГБ встроенной памяти — флагман 2025 года с 6,7-дюймовым дисплеем Super Retina XDR (120 Гц). Смартфон работает на процессоре A19 Pro, имеет 12 ГБ ОЗУ, улучшенную тройную камеру 48 Мп.',
      price: 819585,
      rating: 4.9,
      images: [
        'https://resources.cdn-kaspi.kz/img/m/p/p18/p96/64168413.png?format=gallery-medium',
    ...
    },
    {
      ...
      description: 'Apple iPhone 17 Pro в цвете Midnight Blue (темно-синий) с 256 ГБ встроенной памяти — флагман 2025 года с 6,3-дюймовым дисплеем Super Retina XDR (120 Гц). Смартфон работает на процессоре A19 Pro.',
      price: 739440,
      rating: 4.9,
      images: [
    ...
    },
    {
      ...
      description: 'Apple iPhone 16 128GB (Black) — флагманский смартфон 2024 года с 6,1-дюймовым OLED-дисплеем Super Retina XDR, процессором A18 Bionic.',
      price: 449750,
      rating: 4.9,
      images: [
    ...
    },
    {
      ...
      description: 'Apple iPhone 13 128GB (White) — флагманский смартфон 2021 года с 6,1-дюймовым OLED-дисплеем Super Retina XDR.',
      price: 315284,
      rating: 4.9,
      images: [
    ...
    },
    {
      ...
      description: 'Apple iPhone 17 Pro в цвете Silver (серебристый) с 256 ГБ встроенной памяти — флагман 2025 года.',
      price: 778456,
      rating: 5.0,
      images: [
    ...
    },
    {
      ...
      description: 'Apple iPhone 17 Pro Max в цвете Silver (серебристый) с 256 ГБ встроенной памяти — флагман 2025 года.',
      price: 848835,
      rating: 5.0,
      images: [
    ...
    },
    {
      ...
      description: 'Apple iPhone 17 Pro Max в цвете Midnight Blue (темно-синий) с 256 ГБ встроенной памяти — флагман 2025 года.',
      price: 794400,
      rating: 5.0,
      images: [
